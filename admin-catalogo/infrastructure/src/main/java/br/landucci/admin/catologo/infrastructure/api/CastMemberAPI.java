...
public interface CastMemberAPI {
    ...
    @Operation(summary = "Returns a cast member given an ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Found successfully"),
            @ApiResponse(responseCode = "404", description = "Not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error"),
    })
    FindCastMemberByIDResponseCommand find(@PathVariable(name = "id") String id);
    ...
    ResponseEntity<?> create(@RequestBody CreateCastMemberRequestCommand command);
    ...
    @Operation(summary = "Updates an existing cast member")
    @ApiResponses(value = {
    ...
    ResponseEntity<?> update(@PathVariable(name = "id") String id,
                             @RequestBody UpdateCastMemberRequestCommand command);
    ...
    @Operation(summary = "Deletes an existing cast member")
    @ApiResponses(value = {
